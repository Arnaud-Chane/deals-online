        ...
        <div className="content">
          ...
          <div className="main-para-ctn">
            ...
            <div className="btn-container">
              <div className="btn btn-a btn-amazon">
                <a href="#">
                  <span>How to talk to your cat on Amazon </span>
                  <img src="https://picsum.photos/20" alt="pic of meme" />{" "}
                </a>
              </div>
              <div className="btn btn-a btn-kindle">
                <a href="#">
                  <span>How to talk to your cat on Kindle</span>
                  <img src="https://picsum.photos/20" alt="pic of meme" />{" "}
                </a>
              </div>
